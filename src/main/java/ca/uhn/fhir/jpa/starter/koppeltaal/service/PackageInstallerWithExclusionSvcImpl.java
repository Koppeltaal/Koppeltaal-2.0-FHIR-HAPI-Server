 ...
 * </p>
 * <br/>
 * Exact copy is required as the logic that needs to be overridden is inside
 * private methods.
 * The following is customized:
 * <ol>
 * <li>Certain resources in the package can be excluded</li>
 * <li>Resources with draft status will be installed (overrides
 * <a href="https://github.com/hapifhir/hapi-fhir/pull/2099" target=
 * "_blank">this</a> PR)</li>
 * </ol>
 * 
 * @since 5.1.0
