...
/**
 * <p>
 * <b>** WARNING: Exact copy of the {@link PackageInstallerSvcImpl} class @ b8f4c147 / source/rel_6_2_0 with customizations**</b>
 * </p>
 * <br/>
...
//        return (statusTypes.get(0).getValueAsString().equals("active"));
        return true; //we want to "test" with draft resources as well
    }
  }
